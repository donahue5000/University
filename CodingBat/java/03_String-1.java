...
//in the middle of the out string, e.g. "<<word>>". Note: use str.substring(i, j) to extract the 
...
public boolean endsLy(String str) {
  if (str.length() < 3 && !str.equals("ly")) return false;
...
public String extraFront(String str) {
  String first = "";
  if (str.length() < 2) first = str;
  if (str.length() >= 2) first = str.substring(0, 2);
...
public String deFront(String str) {    
  ...
  String second = "";
  if (str.length() < 1) return str;
  if (str.length() < 2 && str.substring(0,1).equals("a")) return "a";
  if (str.substring(0,1).equals("a")) first = "a";
  if (str.length() < 3 && str.substring(1,2).equals("b")) return first + "b";
  if (str.substring(1,2).equals("b")) second = "b";
...
//the front of the string, or otherwise return the empty string. So, so with the string "hippo" the word 
...
public String startWord(String str, String word) {
  ...
  if (str.length() > 2 && word.length() > 2){
    if (!str.substring(1,3).equals(word.substring(1,3))) return "";
  }
  return str.substring(0,1) + solution;
}
...
public String withoutX(String str) {
  ...
  if (str.substring(0,1).equals("x")){
    solution = str.substring(1);
  }else{
    solution = str;
  }
  if (solution.length() < 1) return solution;
  if (solution.substring(solution.length() -1).equals("x")){
